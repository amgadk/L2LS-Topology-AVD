...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 172.16.100.1 | Port-Channel47 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.1.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 10.255.1.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.1.1 description SPINE2_Vlan4093
